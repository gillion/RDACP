...
define(["jquery",
    ...
    var PlatformRuleTableOutputSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=ruleTableOutput.selectRuleTableOutput&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
		                complete: function(transport){
                            ...
                            if (result.resultJson.length>0){
                                resstr = result.resultJson[0].RuleTableOutput;
                            }
		                }
		            }
		        );
    		...
    		showGridData: function(gridObject){
                var detailgrid= gridObject.kendoGrid({
                    ...
                    columns: [
    	                  ...
    	                  ,{field: "ruleTableId", title:"决策表", align:"center", width: "100px"}
    ...
    return PlatformRuleTableOutputSelDialog;
})