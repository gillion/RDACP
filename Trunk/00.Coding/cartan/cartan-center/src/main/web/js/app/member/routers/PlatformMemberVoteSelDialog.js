...
define(["jquery",
    ...
    var PlatformMemberVoteSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=memberVote.selectMemberVote&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
		                complete: function(transport){
                            ...
                            if (result.resultJson.length>0){
                                resstr = result.resultJson[0].MemberVote;
                            }
		                }
		            }
		        );
    		...
    		showGridData: function(gridObject){
                var detailgrid= gridObject.kendoGrid({
                    ...
                    columns: [
    	                  ...
    	                  ,{field: "votestate", title:"投票状态", align:"center", width: "100px"}
                    ]
                });
                return  detailgrid;
            }
    }
    return PlatformMemberVoteSelDialog;
})