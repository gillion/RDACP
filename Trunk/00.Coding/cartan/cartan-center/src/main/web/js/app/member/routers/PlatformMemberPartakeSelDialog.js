...
define(["jquery",
    ...
    var PlatformMemberPartakeSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=memberPartake.selectMemberPartake&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
		                complete: function(transport){
                            ...
                            if (result.resultJson.length>0){
                                resstr = result.resultJson[0].MemberPartake;
                            }
		                }
		            }
		        );
    ...
    return PlatformMemberPartakeSelDialog;
})