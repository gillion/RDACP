...
define(["types/Class",
    ...
    var PlatformIpfCcmBoGridToolbarManageRouter = BaseRouter.extend({
        routes: {
            "basic_manage/platform_IpfCcmBoGridToolbar_manage": "showPlatformIpfCcmBoGridToolbarManageList",  
            "basic_manage/platform_ckIpfCcmBoGridToolbar_manage": "showPlatformckIpfCcmBoGridToolbarManageList"
        },
        showPlatformckIpfCcmBoGridToolbarManageList: function(){
        ...
        showPlatformIpfCcmBoGridToolbarManageList: function(){
            //var sid=SimpleListUtil.getSessionId();
            //SimpleListUtil.ckSession(sid);            
            var platformIpfCcmBoGridToolbarManageListView = new SimpleListView({
                id: "platform_ipfCcmBoGridToolbar_manage_list",
                title: "基础管理 > IpfCcmBoGridToolbar",
                buttonCount:3,

                ready: function(){
                    this.setSimpleListHeader("IpfCcmBoGridToolbar");
                    this.addToolbarBtn("addBtn", "新 增", function(){
                        ...
                        detailstr+="</div>";
                        showEditDetilDialog(1,"新增","0" ,"router?appKey=000001&method=ipfCcmBoGridToolbar.createIpfCcmBoGridToolbar&v=1.0&format=json",$(detailstr),370);
                        dialogId = null;
                    }, "add");
                    this.addToolbarBtn("deleteBtn", "删 除",function(){
                        var rowCount = platformIpfCcmBoGridToolbarManageListView.getGridObject().select().length;
                        if (rowCount>0){
                        for(var i=0; i<rowCount; i++){
                            rowEl = platformIpfCcmBoGridToolbarManageListView.getGridObject().select().get(i);
                            var ID = SimpleListUtil.getColumnValue(platformIpfCcmBoGridToolbarManageListView.getGridObject(),rowEl, "id");
                            new AjaxEngine("router?appKey=000001&method=ipfCcmBoGridToolbar.deleteIpfCcmBoGridToolbar&v=1.0&format=json",
                            {
                                async: false,
                                data:{id: ID},
                                dataType: 'json',
                    ...
                    this.addToolbarBtn("queryBtn", "查 询", function(){
                        ...
                        detailstr+="</div>";
                        showEditDetilDialog(2,"查询","2" ,"router?appKey=000001&method=ipfCcmBoGridToolbar.selectIpfCcmBoGridToolbar&v=1.0&format=json",$(detailstr),370);
                        dialogId = null;
                    }, "filter");
                },
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: "router?appKey=000001&method=ipfCcmBoGridToolbar.selectIpfCcmBoGridToolbar&v=1.0&format=json"
                        }
                    },
                    schema: {
                        model: {
                        ...
                        data: function(response) {
                            ...
                            result = platformIpfCcmBoGridToolbarManageListView.appendColValue(result);
                            return result;
                        },
                        //记录条数
                    		...
                    		{field: "isHide", title:"隐藏", align:"center", width: "100px"},
                    {
                        ...
                        command: [ {
                            ...
                            click: function(e) {
                                ...
                                platformIpfCcmBoGridToolbarManageListView.selectRow(rowEl);
                                var Id = SimpleListUtil.getSelectedColumnValue(this, "id");
                                var dialogId = "detail_edit_dialog_" + Id;
                                var columnArray = platformIpfCcmBoGridToolbarManageListView.get("columns");
                                var col = null;
                                var colName = null;
                                var value = null;
                                var ColumnValue = {};
				                ...
				                detailstr+="<input id='submitBtn'  name='submitBtn' type='button' value='保 存' />";
				                detailstr+="</div>";
                                showEditDetilDialog(1,"修改",dialogId ,"router?appKey=000001&method=ipfCcmBoGridToolbar.updateIpfCcmBoGridToolbar&v=1.0&format=json", $(detailstr),370);
                                dialogId = null;
                            }
            ...
            this.changePage(platformIpfCcmBoGridToolbarManageListView);
        }
    });

    return PlatformIpfCcmBoGridToolbarManageRouter;
});
