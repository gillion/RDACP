...
define(["jquery",
    ...
    "utils/common"
		...
		AjaxEngine){	
    var PlatformIpfDmlTableSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=ipfDmlTable.selectIpfDmlTable&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
    ...
    return PlatformIpfDmlTableSelDialog;
})