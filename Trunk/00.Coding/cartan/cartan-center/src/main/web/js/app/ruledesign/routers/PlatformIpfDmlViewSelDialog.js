...
define(["jquery",
    ...
    "utils/common"
		...
		AjaxEngine){	
    var PlatformIpfDmlViewSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=ipfDmlView.selectIpfDmlView&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
    ...
    return PlatformIpfDmlViewSelDialog;
})