...
define(["jquery",
    ...
    var PlatformJxkhThreeDepositorySelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("http://liuxibin.vicp.cc:8088/router?appKey=000001&method=jxkhThreeDepository.selectJxkhThreeDepository&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
    ...
    return PlatformJxkhThreeDepositorySelDialog;
})