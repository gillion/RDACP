...
define(["jquery",
    ...
    var PlatformGroupInfoSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=groupInfo.selectGroupInfo&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
		                complete: function(transport){
                            ...
                            if (result.resultJson.length>0){
                                resstr = result.resultJson[0].GroupInfo;
                            }
		                }
		            }
		        );
    		...
    		showGridData: function(gridObject){
                var detailgrid= gridObject.kendoGrid({
                    ...
                    columns: [
    	                  ...
    	                  ,{field: "type", title:"类别", align:"center", width: "100px"}
    ...
    return PlatformGroupInfoSelDialog;
})