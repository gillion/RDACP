...
define(["types/Class",
    ...
    function showEditDetilDialog(tp, titles, id, url, content, height){
        ...
        $("#submitBtn").attr("disabled", true);
            new AjaxEngine(url,
                {
                    async: false,                              
                    data:{id: $("#id").val(),setupId: $("#setupId").val(),tableId: $("#tableId").val(),comboboxField: $("#comboboxField").val(),codeType: $("#codeType").val()},
                    dataType: 'json',
    ...
    var PlatformCodegenerComboboxManageRouter = BaseRouter.extend({
        routes: {
            "basic_manage/platform_CodegenerCombobox_manage": "showPlatformCodegenerComboboxManageList",  
            "basic_manage/platform_ckCodegenerCombobox_manage": "showPlatformckCodegenerComboboxManageList"
        },
        showPlatformckCodegenerComboboxManageList: function(){
        ...
        showPlatformCodegenerComboboxManageList: function(){
            var CodegenerComboboxId=SimpleListUtil.GetQueryString("id");
            var CodegenerComboboxName=decodeURI(SimpleListUtil.GetQueryString("name"));
            //var sid=SimpleListUtil.getSessionId();
            //SimpleListUtil.ckSession(sid);            
            var platformCodegenerComboboxManageListView = new SimpleListView({
                id: "platform_codegenerCombobox_manage_list",
                title: "基础数据 > 下拉组件",
                buttonCount:4,
                
                ready: function(){
                    this.setSimpleListHeader("下拉组件");
                    this.addToolbarBtn("addBtn", "新 增", function(){
                        ...
                        detailstr+="<input id='setupId' name='setupId' hidden='true' data-bind='value: id'  value='"+CodegenerComboboxId+"'style='...'/>";
                        detailstr+="<input id='CodegenerName' name='CodegenerName' data-bind='value: name'  value='"+CodegenerComboboxName+"'style='...'/>";
                        ...
                        detailstr+="<tr>";
                        detailstr+="<td>";
                        detailstr+="<label id='lcomboboxField' align='right'>下拉字段：</label>";
                        detailstr+="</td><td>";
                		detailstr+="<input id='comboboxField' name='下拉字段' style='...'/>";
                        detailstr+="</td>";                        
                        detailstr+="</tr>";
                        ...
                        detailstr+="</div>";
                        showEditDetilDialog(1,"新增","0" ,"router?appKey=000001&method=codegenerCombobox.createCodegenerCombobox&v=1.0&format=json",$(detailstr),186);
                        dialogId = null;
                    }, "add");
                    this.addToolbarBtn("deleteBtn", "删 除",function(){
                        var rowCount = platformCodegenerComboboxManageListView.getGridObject().select().length;
                        if (rowCount>0){
                        for(var i=0; i<rowCount; i++){
                            rowEl = platformCodegenerComboboxManageListView.getGridObject().select().get(i);
                            var ID = SimpleListUtil.getColumnValue(platformCodegenerComboboxManageListView.getGridObject(),rowEl, "id");
                            new AjaxEngine("router?appKey=000001&method=codegenerCombobox.deleteCodegenerCombobox&v=1.0&format=json",
                            {
                                async: false,
                                data:{id: ID},
                                dataType: 'json',
                    ...
                    this.addToolbarBtn("queryBtn", "查 询", function(){
                        ...
                        detailstr+="</div>";
                        showEditDetilDialog(2,"查询","2" ,"router?appKey=000001&method=codegenerCombobox.selectCodegenerCombobox&v=1.0&format=json",$(detailstr),186);
                        dialogId = null;
                    }, "filter");
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: "router?appKey=000001&method=codegenerCombobox.selectCodegenerCombobox&v=1.0&format=json"
                        }
                    },
                    schema: {
                        model: {
                            fields: {
                        		id: { type: "string" },setupId: { type: "string" },tableId: { type: "string" },comboboxField: { type: "string" },codeType: { type: "string" }
                            }
                        },
                        ...
                        data: function(response) {
                            ...
                            result = platformCodegenerComboboxManageListView.appendColValue(result);
                            return result;
                        },
                        //记录条数
                ...
                columns: [
                          ...
                          {field: "id", title:"主键", hidden:"true", align:"center", width: "100px"},
                    		...
                    		{field: "comboboxField", title:"下拉字段", align:"center", width: "100px"},
                    		...
                    		{field: "ComstyleName", title:"代码类型", align:"center", width: "100px"},
                    {
                        ...
                        command: [ {
                            ...
                            click: function(e) {
                                ...
                                platformCodegenerComboboxManageListView.selectRow(rowEl);
                                var Id = SimpleListUtil.getSelectedColumnValue(this, "id");
                                var dialogId = "detail_edit_dialog_" + Id;
                                var columnArray = platformCodegenerComboboxManageListView.get("columns");
                                var col = null;
                                var colName = null;
                                var value = null;
                                var ColumnValue = {};
                        		...
                        		detailstr+="<input id='comboboxField' name='下拉字段' value='"+ColumnValue["comboboxField"]+"' style='...'/>";
                                detailstr+="</td>";
                                detailstr+="</tr>";
                                detailstr+="<tr>";
                                detailstr+="<td>";
				                ...
				                detailstr+="<input id='submitBtn'  name='submitBtn' type='button' value='保 存' />";
				                detailstr+="</div>";
                                showEditDetilDialog(1,"修改",dialogId ,"router?appKey=000001&method=codegenerCombobox.updateCodegenerCombobox&v=1.0&format=json", $(detailstr),186);
                                dialogId = null;
                            }
            ...
            this.changePage(platformCodegenerComboboxManageListView);
        }
    });

    return PlatformCodegenerComboboxManageRouter;
});
