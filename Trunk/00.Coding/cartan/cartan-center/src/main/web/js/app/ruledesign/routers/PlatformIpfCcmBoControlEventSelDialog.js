...
define(["jquery",
    ...
    var PlatformIpfCcmBoControlEventSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=ipfCcmBoControlEvent.selectIpfCcmBoControlEvent&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
		                complete: function(transport){
                            ...
                            if (result.resultJson.length>0){
                                resstr = result.resultJson[0].IpfCcmBoControlEvent;
                            }
		                }
		            }
		        );
    ...
    return PlatformIpfCcmBoControlEventSelDialog;
})