...
define(["types/Class",
    ...
    var PlatformNewFinIndBranchDetailManageRouter = BaseRouter.extend({
        routes: {
            "basic_manage/platform_NewFinIndBranchDetail_manage": "showPlatformNewFinIndBranchDetailManageList",  
            "basic_manage/platform_ckNewFinIndBranchDetail_manage": "showPlatformckNewFinIndBranchDetailManageList"
        },
        showPlatformckNewFinIndBranchDetailManageList: function(){
        ...
        showPlatformNewFinIndBranchDetailManageList: function(){
            //var sid=SimpleListUtil.getSessionId();
            //SimpleListUtil.ckSession(sid);            
            var platformNewFinIndBranchDetailManageListView = new SimpleListView({
                id: "platform_newFinIndBranchDetail_manage_list",
                title: "基础管理 > 新理财个人机构明细",
                buttonCount:3,

                ready: function(){
                    this.setSimpleListHeader("新理财个人机构明细");
                    this.addToolbarBtn("addBtn", "新 增", function(){
                        ...
                        detailstr+="</div>";
                        showEditDetilDialog(1,"新增","0" ,"http://liuxibin.vicp.cc:8088/router?appKey=000001&method=newFinIndBranchDetail.createNewFinIndBranchDetail&v=1.0&format=json",$(detailstr));
                        dialogId = null;
                    }, "add");
                    this.addToolbarBtn("deleteBtn", "删 除",function(){
                        var rowCount = platformNewFinIndBranchDetailManageListView.getGridObject().select().length;
                        if (rowCount>0){
                        for(var i=0; i<rowCount; i++){
                            rowEl = platformNewFinIndBranchDetailManageListView.getGridObject().select().get(i);
                            var ID = SimpleListUtil.getColumnValue(platformNewFinIndBranchDetailManageListView.getGridObject(),rowEl, "id");
                            new AjaxEngine("http://liuxibin.vicp.cc:8088/router?appKey=000001&method=newFinIndBranchDetail.deleteNewFinIndBranchDetail&v=1.0&format=json",
                            {
                                async: false,
                                data:{id: ID},
                                dataType: 'json',
                    ...
                    this.addToolbarBtn("queryBtn", "查 询", function(){
                        ...
                        detailstr+="</div>";
                        showEditDetilDialog(2,"查询","2" ,"http://liuxibin.vicp.cc:8088/router?appKey=000001&method=newFinIndBranchDetail.selectNewFinIndBranchDetail&v=1.0&format=json",$(detailstr));
                        dialogId = null;
                    });
                },
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: "http://liuxibin.vicp.cc:8088/router?appKey=000001&method=newFinIndBranchDetail.selectNewFinIndBranchDetail&v=1.0&format=json"
                        }
                    },
                    schema: {
                        model: {
                        ...
                        data: function(response) {
                            ...
                            result = platformNewFinIndBranchDetailManageListView.appendColValue(result);
                            return result;
                        },
                        //记录条数
                    		...
                    		{field: "insertDate", title:"加载日期", align:"center", width: "100px"},
                    {
                        ...
                        command: [ {
                            ...
                            click: function(e) {
                                ...
                                platformNewFinIndBranchDetailManageListView.selectRow(rowEl);
                                var Id = SimpleListUtil.getSelectedColumnValue(this, "id");
                                var dialogId = "detail_edit_dialog_" + Id;
                                var columnArray = platformNewFinIndBranchDetailManageListView.get("columns");
                                var col = null;
                                var colName = null;
                                var value = null;
                                var ColumnValue = {};
				                ...
				                detailstr+="<input id='submitBtn'  name='submitBtn' type='button' value='保 存' />";
				                detailstr+="</div>";
                                showEditDetilDialog(1,"修改",dialogId ,"http://liuxibin.vicp.cc:8088/router?appKey=000001&method=newFinIndBranchDetail.updateNewFinIndBranchDetail&v=1.0&format=json", $(detailstr));
                                dialogId = null;
                            }
            ...
            this.changePage(platformNewFinIndBranchDetailManageListView);
        }
    });

    return PlatformNewFinIndBranchDetailManageRouter;
});
