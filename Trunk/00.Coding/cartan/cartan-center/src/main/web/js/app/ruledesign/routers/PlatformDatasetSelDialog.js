...
define(["jquery",
    ...
    var PlatformDatasetSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=dataset.selectDataset&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
		                complete: function(transport){
                            ...
                            if (result.resultJson.length>0){
                                resstr = result.resultJson[0].datasetDes;
                            }
		                }
		            }
		        );
    		...
    		showGridData: function(gridObject){
                var detailgrid= gridObject.kendoGrid({
                    ...
                    columns: [
    	                  ...
    	                  ,{field: "datasetType", title:"类型", align:"center", width: "100px"}
    ...
    return PlatformDatasetSelDialog;
})