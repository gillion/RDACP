...
define(["types/Class",
    ...
    function showEditDetilDialog(tp, titles, id, url, content){
        ...
        $("#submitBtn").click(function(){
            new AjaxEngine(url,
                {
                    async: false,                              
                    data:{id: $("#id").val(),syear: $("#syear").val(),smonth: $("#smonth").val(),senddate: $("#senddate").val(),stype: $("#stype").val(),dept: $("#dept").val(),incomeDate: $("#incomeDate").val(),blanceavgBase: $("#blanceavgBase").val(),balanceavgAll: $("#balanceavgAll").val(),balanceavgIncremental: $("#balanceavgIncremental").val(),monthTask: $("#monthTask").val(),incrementalTime: $("#incrementalTime").val(),lastResult: $("#lastResult").val()},
                    dataType: 'json',
    ...
    var PlatformJxkhPerdepttotalJxManageRouter = BaseRouter.extend({
        routes: {
            "basic_manage/platform_JxkhPerdepttotalJx_manage": "showPlatformJxkhPerdepttotalJxManageList",  
            "basic_manage/platform_ckJxkhPerdepttotalJx_manage": "showPlatformckJxkhPerdepttotalJxManageList"
        },
        showPlatformckJxkhPerdepttotalJxManageList: function(){
        ...
        showPlatformJxkhPerdepttotalJxManageList: function(){
            //var sid=SimpleListUtil.getSessionId();
            //SimpleListUtil.ckSession(sid);            
            var platformJxkhPerdepttotalJxManageListView = new SimpleListView({
                id: "platform_jxkhPerdepttotalJx_manage_list",
                title: "基础管理 > 对私部门绩效核算",
                buttonCount:3,

                ready: function(){
                    this.setSimpleListHeader("对私部门绩效核算");
                    this.addToolbarBtn("addBtn", "新 增", function(){
                        ...
                        detailstr+="</div>";
                        showEditDetilDialog(1,"新增","0" ,"http://liuxibin.vicp.cc:8088/router?appKey=000001&method=jxkhPerdepttotalJx.createJxkhPerdepttotalJx&v=1.0&format=json",$(detailstr));
                        dialogId = null;
                    }, "add");
                    this.addToolbarBtn("deleteBtn", "删 除",function(){
                        var rowCount = platformJxkhPerdepttotalJxManageListView.getGridObject().select().length;
                        if (rowCount>0){
                        for(var i=0; i<rowCount; i++){
                            rowEl = platformJxkhPerdepttotalJxManageListView.getGridObject().select().get(i);
                            var ID = SimpleListUtil.getColumnValue(platformJxkhPerdepttotalJxManageListView.getGridObject(),rowEl, "id");
                            new AjaxEngine("http://liuxibin.vicp.cc:8088/router?appKey=000001&method=jxkhPerdepttotalJx.deleteJxkhPerdepttotalJx&v=1.0&format=json",
                            {
                                async: false,
                                data:{id: ID},
                                dataType: 'json',
                    ...
                    this.addToolbarBtn("queryBtn", "查 询", function(){
                        ...
                        detailstr+="</div>";
                        showEditDetilDialog(2,"查询","2" ,"http://liuxibin.vicp.cc:8088/router?appKey=000001&method=jxkhPerdepttotalJx.selectJxkhPerdepttotalJx&v=1.0&format=json",$(detailstr));
                        dialogId = null;
                    });
                },
                ...
                dataSource: {
                    ...
                    schema: {
                        ...
                        data: function(response) {
                            ...
                            result = platformJxkhPerdepttotalJxManageListView.appendColValue(result);
                            return result;
                        },
                        //记录条数
                    		...
                    		{field: "lastResult", title:"得分", align:"center", width: "100px"},
                    {
                        ...
                        command: [ {
                            ...
                            click: function(e) {
                                ...
                                platformJxkhPerdepttotalJxManageListView.selectRow(rowEl);
                                var Id = SimpleListUtil.getSelectedColumnValue(this, "id");
                                var dialogId = "detail_edit_dialog_" + Id;
                                var columnArray = platformJxkhPerdepttotalJxManageListView.get("columns");
                                var col = null;
                                var colName = null;
                                var value = null;
                                var ColumnValue = {};
				                ...
				                detailstr+="<input id='submitBtn'  name='submitBtn' type='button' value='保 存' />";
				                detailstr+="</div>";
                                showEditDetilDialog(1,"修改",dialogId ,"http://liuxibin.vicp.cc:8088/router?appKey=000001&method=jxkhPerdepttotalJx.updateJxkhPerdepttotalJx&v=1.0&format=json", $(detailstr));
                                dialogId = null;
                            }
            ...
            this.changePage(platformJxkhPerdepttotalJxManageListView);
        }
    });

    return PlatformJxkhPerdepttotalJxManageRouter;
});
