...
define(["jquery",
    ...
    var PlatformRuleTreeOutputSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=ruleTreeOutput.selectRuleTreeOutput&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
		                complete: function(transport){
                            ...
                            if (result.resultJson.length>0){
                                resstr = result.resultJson[0].RuleTreeOutput;
                            }
		                }
		            }
		        );
    		...
    		showGridData: function(gridObject){
                var detailgrid= gridObject.kendoGrid({
                    ...
                    columns: [
    	                  ...
    	                  ,{field: "ruleTreeId", title:"决策树", align:"center", width: "100px"}
    ...
    return PlatformRuleTreeOutputSelDialog;
})