...
define(["jquery",
    ...
    "utils/common"
		...
		AjaxEngine){	
    var PlatformCodegenerCheckboxSelDialog = {
    		codetodes: function(id){
		        ...
		        new AjaxEngine("router?appKey=000001&method=codegenerCheckbox.selectCodegenerCheckbox&v=1.0&format=json",
		            {
		                async: false,
		                data:{id: id},
		                dataType: 'json',
		                complete: function(transport){
                            ...
                            if (result.resultJson.length>0){
                                resstr = result.resultJson[0].CodegenerCheckbox;
                            }
		                }
		            }
		        );
    ...
    return PlatformCodegenerCheckboxSelDialog;
})