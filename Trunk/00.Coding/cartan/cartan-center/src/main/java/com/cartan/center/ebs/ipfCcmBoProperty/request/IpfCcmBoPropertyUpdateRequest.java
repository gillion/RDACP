...
public class IpfCcmBoPropertyUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoPropertyUpdateRequest(){}
	
	public IpfCcmBoPropertyUpdateRequest(IpfCcmBoProperty ipfCcmBoProperty){
	...
	public static List<IpfCcmBoProperty> cloneBOList(List<IpfCcmBoPropertyUpdateRequest> vos){
		...
		for(IpfCcmBoPropertyUpdateRequest vo: vos){
