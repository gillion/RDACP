...
public class IpfDmlViewCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlViewCreateRequest(){}
	
	public IpfDmlViewCreateRequest(IpfDmlView ipfDmlView){
