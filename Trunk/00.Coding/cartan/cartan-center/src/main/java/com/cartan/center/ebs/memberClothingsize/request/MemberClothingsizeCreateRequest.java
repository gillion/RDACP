...
public class MemberClothingsizeCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public MemberClothingsizeCreateRequest(){}
	
	public MemberClothingsizeCreateRequest(MemberClothingsize memberClothingsize){
	...
	public static List<MemberClothingsize> cloneBOList(List<MemberClothingsizeCreateRequest> vos){
		...
		for(MemberClothingsizeCreateRequest vo: vos){
