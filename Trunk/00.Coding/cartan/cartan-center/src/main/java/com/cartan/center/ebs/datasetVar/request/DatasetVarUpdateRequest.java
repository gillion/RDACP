...
public class DatasetVarUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public DatasetVarUpdateRequest(){}
	
	public DatasetVarUpdateRequest(DatasetVar datasetVar){
