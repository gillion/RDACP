...
public class RuleTableInputCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public RuleTableInputCreateRequest(){}
	
	public RuleTableInputCreateRequest(RuleTableInput ruleTableInput){
	...
	public static List<RuleTableInput> cloneBOList(List<RuleTableInputCreateRequest> vos){
		...
		for(RuleTableInputCreateRequest vo: vos){
