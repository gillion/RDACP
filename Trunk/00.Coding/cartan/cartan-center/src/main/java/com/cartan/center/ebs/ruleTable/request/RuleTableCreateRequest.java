...
public class RuleTableCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public RuleTableCreateRequest(){}
	
	public RuleTableCreateRequest(RuleTable ruleTable){
