...
public class IpfDmlConstraintUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlConstraintUpdateRequest(){}
	
	public IpfDmlConstraintUpdateRequest(IpfDmlConstraint ipfDmlConstraint){
	...
	public static List<IpfDmlConstraint> cloneBOList(List<IpfDmlConstraintUpdateRequest> vos){
		...
		for(IpfDmlConstraintUpdateRequest vo: vos){
