...
public class IpfCcmBoCheckFieldUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoCheckFieldUpdateRequest(){}
	
	public IpfCcmBoCheckFieldUpdateRequest(IpfCcmBoCheckField ipfCcmBoCheckField){
	...
	public static List<IpfCcmBoCheckField> cloneBOList(List<IpfCcmBoCheckFieldUpdateRequest> vos){
		...
		for(IpfCcmBoCheckFieldUpdateRequest vo: vos){
