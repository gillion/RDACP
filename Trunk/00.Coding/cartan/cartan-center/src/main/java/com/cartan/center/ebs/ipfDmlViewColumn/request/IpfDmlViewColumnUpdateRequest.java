...
public class IpfDmlViewColumnUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlViewColumnUpdateRequest(){}
	
	public IpfDmlViewColumnUpdateRequest(IpfDmlViewColumn ipfDmlViewColumn){
	...
	public static List<IpfDmlViewColumn> cloneBOList(List<IpfDmlViewColumnUpdateRequest> vos){
		...
		for(IpfDmlViewColumnUpdateRequest vo: vos){
