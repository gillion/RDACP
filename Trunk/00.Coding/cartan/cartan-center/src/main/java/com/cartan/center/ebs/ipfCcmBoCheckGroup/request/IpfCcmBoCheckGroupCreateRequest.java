...
public class IpfCcmBoCheckGroupCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoCheckGroupCreateRequest(){}
	
	public IpfCcmBoCheckGroupCreateRequest(IpfCcmBoCheckGroup ipfCcmBoCheckGroup){
	...
	public static List<IpfCcmBoCheckGroup> cloneBOList(List<IpfCcmBoCheckGroupCreateRequest> vos){
		...
		for(IpfCcmBoCheckGroupCreateRequest vo: vos){
