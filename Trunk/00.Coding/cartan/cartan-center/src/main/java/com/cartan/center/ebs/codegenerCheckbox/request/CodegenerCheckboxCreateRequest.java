...
public class CodegenerCheckboxCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public CodegenerCheckboxCreateRequest(){}
	
	public CodegenerCheckboxCreateRequest(CodegenerCheckbox codegenerCheckbox){
	...
	public static List<CodegenerCheckbox> cloneBOList(List<CodegenerCheckboxCreateRequest> vos){
		...
		for(CodegenerCheckboxCreateRequest vo: vos){
