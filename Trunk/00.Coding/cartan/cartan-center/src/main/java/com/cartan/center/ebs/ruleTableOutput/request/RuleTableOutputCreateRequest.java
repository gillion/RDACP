...
public class RuleTableOutputCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public RuleTableOutputCreateRequest(){}
	
	public RuleTableOutputCreateRequest(RuleTableOutput ruleTableOutput){
	...
	public static List<RuleTableOutput> cloneBOList(List<RuleTableOutputCreateRequest> vos){
		...
		for(RuleTableOutputCreateRequest vo: vos){
