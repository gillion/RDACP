...
public class IpfCcmBoFormToolbarSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoFormToolbarSelectRequest(){}
	
	public IpfCcmBoFormToolbarSelectRequest(IpfCcmBoFormToolbar ipfCcmBoFormToolbar){
	...
	public static List<IpfCcmBoFormToolbar> cloneBOList(List<IpfCcmBoFormToolbarSelectRequest> vos){
		...
		for(IpfCcmBoFormToolbarSelectRequest vo: vos){
