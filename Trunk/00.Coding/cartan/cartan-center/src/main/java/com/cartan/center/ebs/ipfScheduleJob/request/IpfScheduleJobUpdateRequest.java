...
public class IpfScheduleJobUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfScheduleJobUpdateRequest(){}
	
	public IpfScheduleJobUpdateRequest(IpfScheduleJob ipfScheduleJob){
	...
	public static List<IpfScheduleJob> cloneBOList(List<IpfScheduleJobUpdateRequest> vos){
		...
		for(IpfScheduleJobUpdateRequest vo: vos){
