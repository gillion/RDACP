...
public class IpfCcmBoCheckFieldCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoCheckFieldCreateRequest(){}
	
	public IpfCcmBoCheckFieldCreateRequest(IpfCcmBoCheckField ipfCcmBoCheckField){
	...
	public static List<IpfCcmBoCheckField> cloneBOList(List<IpfCcmBoCheckFieldCreateRequest> vos){
		...
		for(IpfCcmBoCheckFieldCreateRequest vo: vos){
