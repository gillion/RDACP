...
public class IpfCcmBoGridToolbarUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoGridToolbarUpdateRequest(){}
	
	public IpfCcmBoGridToolbarUpdateRequest(IpfCcmBoGridToolbar ipfCcmBoGridToolbar){
	...
	public static List<IpfCcmBoGridToolbar> cloneBOList(List<IpfCcmBoGridToolbarUpdateRequest> vos){
		...
		for(IpfCcmBoGridToolbarUpdateRequest vo: vos){
