...
public class IpfCcmShlpDetailSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmShlpDetailSelectRequest(){}
	
	public IpfCcmShlpDetailSelectRequest(IpfCcmShlpDetail ipfCcmShlpDetail){
	...
	public static List<IpfCcmShlpDetail> cloneBOList(List<IpfCcmShlpDetailSelectRequest> vos){
		...
		for(IpfCcmShlpDetailSelectRequest vo: vos){
