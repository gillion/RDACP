...
public class IpfCcmBoFormCellCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoFormCellCreateRequest(){}
	
	public IpfCcmBoFormCellCreateRequest(IpfCcmBoFormCell ipfCcmBoFormCell){
	...
	public static List<IpfCcmBoFormCell> cloneBOList(List<IpfCcmBoFormCellCreateRequest> vos){
		...
		for(IpfCcmBoFormCellCreateRequest vo: vos){
