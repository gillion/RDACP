...
public class IpfCcmBoMethodParamUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoMethodParamUpdateRequest(){}
	
	public IpfCcmBoMethodParamUpdateRequest(IpfCcmBoMethodParam ipfCcmBoMethodParam){
	...
	public static List<IpfCcmBoMethodParam> cloneBOList(List<IpfCcmBoMethodParamUpdateRequest> vos){
		...
		for(IpfCcmBoMethodParamUpdateRequest vo: vos){
