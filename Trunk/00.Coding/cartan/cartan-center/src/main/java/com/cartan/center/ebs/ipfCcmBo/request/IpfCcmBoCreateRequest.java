...
public class IpfCcmBoCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoCreateRequest(){}
	
	public IpfCcmBoCreateRequest(IpfCcmBo ipfCcmBo){
