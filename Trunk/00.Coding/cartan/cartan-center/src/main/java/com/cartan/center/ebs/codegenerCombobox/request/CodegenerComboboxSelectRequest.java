...
public class CodegenerComboboxSelectRequest extends AbstractRopRequest {
	...
	public CodegenerComboboxSelectRequest(){}
	
	public CodegenerComboboxSelectRequest(CodegenerCombobox codegenerCombobox){
	...
	public static List<CodegenerCombobox> cloneBOList(List<CodegenerComboboxSelectRequest> vos){
		...
		for(CodegenerComboboxSelectRequest vo: vos){
