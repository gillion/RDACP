...
public class IpfDmlElementCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlElementCreateRequest(){}
	
	public IpfDmlElementCreateRequest(IpfDmlElement ipfDmlElement){
	...
	public static List<IpfDmlElement> cloneBOList(List<IpfDmlElementCreateRequest> vos){
		...
		for(IpfDmlElementCreateRequest vo: vos){
