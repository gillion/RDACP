...
public class IpfCcmBizruleDtlParamSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBizruleDtlParamSelectRequest(){}
	
	public IpfCcmBizruleDtlParamSelectRequest(IpfCcmBizruleDtlParam ipfCcmBizruleDtlParam){
	...
	public static List<IpfCcmBizruleDtlParam> cloneBOList(List<IpfCcmBizruleDtlParamSelectRequest> vos){
		...
		for(IpfCcmBizruleDtlParamSelectRequest vo: vos){
