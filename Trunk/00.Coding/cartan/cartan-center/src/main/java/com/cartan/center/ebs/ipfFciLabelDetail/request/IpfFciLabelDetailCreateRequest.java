...
public class IpfFciLabelDetailCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfFciLabelDetailCreateRequest(){}
	
	public IpfFciLabelDetailCreateRequest(IpfFciLabelDetail ipfFciLabelDetail){
	...
	public static List<IpfFciLabelDetail> cloneBOList(List<IpfFciLabelDetailCreateRequest> vos){
		...
		for(IpfFciLabelDetailCreateRequest vo: vos){
