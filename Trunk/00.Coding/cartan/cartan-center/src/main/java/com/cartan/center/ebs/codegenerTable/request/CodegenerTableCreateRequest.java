...
public class CodegenerTableCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public CodegenerTableCreateRequest(){}
	
	public CodegenerTableCreateRequest(CodegenerTable codegenerTable){
	...
	public static List<CodegenerTable> cloneBOList(List<CodegenerTableCreateRequest> vos){
		...
		for(CodegenerTableCreateRequest vo: vos){
