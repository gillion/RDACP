...
public class IpfCcmBoGridColumnCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoGridColumnCreateRequest(){}
	
	public IpfCcmBoGridColumnCreateRequest(IpfCcmBoGridColumn ipfCcmBoGridColumn){
	...
	public static List<IpfCcmBoGridColumn> cloneBOList(List<IpfCcmBoGridColumnCreateRequest> vos){
		...
		for(IpfCcmBoGridColumnCreateRequest vo: vos){
