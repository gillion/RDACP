...
public class IpfCcmBoUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoUpdateRequest(){}
	
	public IpfCcmBoUpdateRequest(IpfCcmBo ipfCcmBo){
