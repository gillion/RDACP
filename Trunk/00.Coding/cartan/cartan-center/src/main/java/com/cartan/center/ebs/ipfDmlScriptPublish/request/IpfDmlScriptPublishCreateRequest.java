...
public class IpfDmlScriptPublishCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlScriptPublishCreateRequest(){}
	
	public IpfDmlScriptPublishCreateRequest(IpfDmlScriptPublish ipfDmlScriptPublish){
	...
	public static List<IpfDmlScriptPublish> cloneBOList(List<IpfDmlScriptPublishCreateRequest> vos){
		...
		for(IpfDmlScriptPublishCreateRequest vo: vos){
