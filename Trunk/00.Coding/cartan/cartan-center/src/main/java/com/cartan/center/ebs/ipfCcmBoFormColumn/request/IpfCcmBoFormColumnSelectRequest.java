...
public class IpfCcmBoFormColumnSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoFormColumnSelectRequest(){}
	
	public IpfCcmBoFormColumnSelectRequest(IpfCcmBoFormColumn ipfCcmBoFormColumn){
	...
	public static List<IpfCcmBoFormColumn> cloneBOList(List<IpfCcmBoFormColumnSelectRequest> vos){
		...
		for(IpfCcmBoFormColumnSelectRequest vo: vos){
