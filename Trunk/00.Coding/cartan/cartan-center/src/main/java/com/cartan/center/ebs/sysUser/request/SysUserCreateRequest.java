 ...
 * @date: 2013-09-05
 */
public class SysUserCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 36)
	...
	public SysUserCreateRequest(SysUser sysUser){
