...
public class IpfRtmConfigAttrCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRtmConfigAttrCreateRequest(){}
	
	public IpfRtmConfigAttrCreateRequest(IpfRtmConfigAttr ipfRtmConfigAttr){
	...
	public static List<IpfRtmConfigAttr> cloneBOList(List<IpfRtmConfigAttrCreateRequest> vos){
		...
		for(IpfRtmConfigAttrCreateRequest vo: vos){
