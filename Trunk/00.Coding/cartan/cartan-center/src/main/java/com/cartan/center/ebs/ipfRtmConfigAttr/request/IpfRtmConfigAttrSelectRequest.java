...
public class IpfRtmConfigAttrSelectRequest extends AbstractRopRequest {
	...
	public IpfRtmConfigAttrSelectRequest(){}
	
	public IpfRtmConfigAttrSelectRequest(IpfRtmConfigAttr ipfRtmConfigAttr){
	...
	public static List<IpfRtmConfigAttr> cloneBOList(List<IpfRtmConfigAttrSelectRequest> vos){
		...
		for(IpfRtmConfigAttrSelectRequest vo: vos){
