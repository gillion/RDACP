...
public class IpfDmlTableUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlTableUpdateRequest(){}
	
	public IpfDmlTableUpdateRequest(IpfDmlTable ipfDmlTable){
