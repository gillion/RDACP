...
public class IpfCcmShlpDetailCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmShlpDetailCreateRequest(){}
	
	public IpfCcmShlpDetailCreateRequest(IpfCcmShlpDetail ipfCcmShlpDetail){
	...
	public static List<IpfCcmShlpDetail> cloneBOList(List<IpfCcmShlpDetailCreateRequest> vos){
		...
		for(IpfCcmShlpDetailCreateRequest vo: vos){
