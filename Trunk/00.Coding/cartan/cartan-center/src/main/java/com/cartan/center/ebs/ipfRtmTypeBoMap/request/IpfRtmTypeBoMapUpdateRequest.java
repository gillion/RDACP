...
public class IpfRtmTypeBoMapUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRtmTypeBoMapUpdateRequest(){}
	
	public IpfRtmTypeBoMapUpdateRequest(IpfRtmTypeBoMap ipfRtmTypeBoMap){
	...
	public static List<IpfRtmTypeBoMap> cloneBOList(List<IpfRtmTypeBoMapUpdateRequest> vos){
		...
		for(IpfRtmTypeBoMapUpdateRequest vo: vos){
