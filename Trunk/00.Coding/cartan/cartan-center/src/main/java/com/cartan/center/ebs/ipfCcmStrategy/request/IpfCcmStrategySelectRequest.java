...
public class IpfCcmStrategySelectRequest extends AbstractRopRequest {
	...
	public IpfCcmStrategySelectRequest(){}
	
	public IpfCcmStrategySelectRequest(IpfCcmStrategy ipfCcmStrategy){
	...
	public static List<IpfCcmStrategy> cloneBOList(List<IpfCcmStrategySelectRequest> vos){
		...
		for(IpfCcmStrategySelectRequest vo: vos){
