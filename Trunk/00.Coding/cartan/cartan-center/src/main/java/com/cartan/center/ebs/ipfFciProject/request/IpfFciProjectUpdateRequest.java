...
public class IpfFciProjectUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfFciProjectUpdateRequest(){}
	
	public IpfFciProjectUpdateRequest(IpfFciProject ipfFciProject){
	...
	public static List<IpfFciProject> cloneBOList(List<IpfFciProjectUpdateRequest> vos){
		...
		for(IpfFciProjectUpdateRequest vo: vos){
