...
public class MemberPartakeUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public MemberPartakeUpdateRequest(){}
	
	public MemberPartakeUpdateRequest(MemberPartake memberPartake){
	...
	public static List<MemberPartake> cloneBOList(List<MemberPartakeUpdateRequest> vos){
		...
		for(MemberPartakeUpdateRequest vo: vos){
