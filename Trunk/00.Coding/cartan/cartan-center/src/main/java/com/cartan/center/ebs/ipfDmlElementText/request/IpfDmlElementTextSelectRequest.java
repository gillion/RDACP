...
public class IpfDmlElementTextSelectRequest extends AbstractRopRequest {
	...
	public IpfDmlElementTextSelectRequest(){}
	
	public IpfDmlElementTextSelectRequest(IpfDmlElementText ipfDmlElementText){
	...
	public static List<IpfDmlElementText> cloneBOList(List<IpfDmlElementTextSelectRequest> vos){
		...
		for(IpfDmlElementTextSelectRequest vo: vos){
