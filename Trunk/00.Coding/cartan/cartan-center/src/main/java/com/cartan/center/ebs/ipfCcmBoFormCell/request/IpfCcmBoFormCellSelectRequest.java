...
public class IpfCcmBoFormCellSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoFormCellSelectRequest(){}
	
	public IpfCcmBoFormCellSelectRequest(IpfCcmBoFormCell ipfCcmBoFormCell){
	...
	public static List<IpfCcmBoFormCell> cloneBOList(List<IpfCcmBoFormCellSelectRequest> vos){
		...
		for(IpfCcmBoFormCellSelectRequest vo: vos){
