...
public class IpfCcmDictSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmDictSelectRequest(){}
	
	public IpfCcmDictSelectRequest(IpfCcmDict ipfCcmDict){
