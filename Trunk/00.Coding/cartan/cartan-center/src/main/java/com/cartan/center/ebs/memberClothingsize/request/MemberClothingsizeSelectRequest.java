...
public class MemberClothingsizeSelectRequest extends AbstractRopRequest {
	...
	public MemberClothingsizeSelectRequest(){}
	
	public MemberClothingsizeSelectRequest(MemberClothingsize memberClothingsize){
	...
	public static List<MemberClothingsize> cloneBOList(List<MemberClothingsizeSelectRequest> vos){
		...
		for(MemberClothingsizeSelectRequest vo: vos){
