...
public class IpfRuleRotateSelectRequest extends AbstractRopRequest {
	...
	public IpfRuleRotateSelectRequest(){}
	
	public IpfRuleRotateSelectRequest(IpfRuleRotate ipfRuleRotate){
	...
	public static List<IpfRuleRotate> cloneBOList(List<IpfRuleRotateSelectRequest> vos){
		...
		for(IpfRuleRotateSelectRequest vo: vos){
