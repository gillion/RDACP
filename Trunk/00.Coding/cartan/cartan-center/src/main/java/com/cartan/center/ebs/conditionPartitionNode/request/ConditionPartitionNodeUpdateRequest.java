...
public class ConditionPartitionNodeUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public ConditionPartitionNodeUpdateRequest(){}
	
	public ConditionPartitionNodeUpdateRequest(ConditionPartitionNode conditionPartitionNode){
	...
	public static List<ConditionPartitionNode> cloneBOList(List<ConditionPartitionNodeUpdateRequest> vos){
		...
		for(ConditionPartitionNodeUpdateRequest vo: vos){
