...
public class IpfCcmTemplateUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmTemplateUpdateRequest(){}
	
	public IpfCcmTemplateUpdateRequest(IpfCcmTemplate ipfCcmTemplate){
	...
	public static List<IpfCcmTemplate> cloneBOList(List<IpfCcmTemplateUpdateRequest> vos){
		...
		for(IpfCcmTemplateUpdateRequest vo: vos){
