...
public class MemberPartakeSelectRequest extends AbstractRopRequest {
	...
	public MemberPartakeSelectRequest(){}
	
	public MemberPartakeSelectRequest(MemberPartake memberPartake){
	...
	public static List<MemberPartake> cloneBOList(List<MemberPartakeSelectRequest> vos){
		...
		for(MemberPartakeSelectRequest vo: vos){
