...
public class IpfCcmBoMethodUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoMethodUpdateRequest(){}
	
	public IpfCcmBoMethodUpdateRequest(IpfCcmBoMethod ipfCcmBoMethod){
	...
	public static List<IpfCcmBoMethod> cloneBOList(List<IpfCcmBoMethodUpdateRequest> vos){
		...
		for(IpfCcmBoMethodUpdateRequest vo: vos){
