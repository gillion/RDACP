...
public class IpfFciViewCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfFciViewCreateRequest(){}
	
	public IpfFciViewCreateRequest(IpfFciView ipfFciView){
