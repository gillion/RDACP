...
public class ComstyleUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public ComstyleUpdateRequest(){}
	
	public ComstyleUpdateRequest(Comstyle comstyle){
