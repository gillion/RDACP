...
public class IpfCcmNumruleListUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmNumruleListUpdateRequest(){}
	
	public IpfCcmNumruleListUpdateRequest(IpfCcmNumruleList ipfCcmNumruleList){
	...
	public static List<IpfCcmNumruleList> cloneBOList(List<IpfCcmNumruleListUpdateRequest> vos){
		...
		for(IpfCcmNumruleListUpdateRequest vo: vos){
