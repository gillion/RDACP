...
public class IpfRtmTypeBoCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRtmTypeBoCreateRequest(){}
	
	public IpfRtmTypeBoCreateRequest(IpfRtmTypeBo ipfRtmTypeBo){
