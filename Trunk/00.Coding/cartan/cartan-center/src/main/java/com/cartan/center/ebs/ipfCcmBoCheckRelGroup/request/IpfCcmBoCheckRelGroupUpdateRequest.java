...
public class IpfCcmBoCheckRelGroupUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoCheckRelGroupUpdateRequest(){}
	
	public IpfCcmBoCheckRelGroupUpdateRequest(IpfCcmBoCheckRelGroup ipfCcmBoCheckRelGroup){
	...
	public static List<IpfCcmBoCheckRelGroup> cloneBOList(List<IpfCcmBoCheckRelGroupUpdateRequest> vos){
		...
		for(IpfCcmBoCheckRelGroupUpdateRequest vo: vos){
