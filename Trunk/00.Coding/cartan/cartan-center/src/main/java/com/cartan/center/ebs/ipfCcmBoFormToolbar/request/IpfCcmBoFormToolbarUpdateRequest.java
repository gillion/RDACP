...
public class IpfCcmBoFormToolbarUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoFormToolbarUpdateRequest(){}
	
	public IpfCcmBoFormToolbarUpdateRequest(IpfCcmBoFormToolbar ipfCcmBoFormToolbar){
	...
	public static List<IpfCcmBoFormToolbar> cloneBOList(List<IpfCcmBoFormToolbarUpdateRequest> vos){
		...
		for(IpfCcmBoFormToolbarUpdateRequest vo: vos){
