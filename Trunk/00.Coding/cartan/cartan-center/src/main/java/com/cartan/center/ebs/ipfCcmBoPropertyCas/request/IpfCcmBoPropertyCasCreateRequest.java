...
public class IpfCcmBoPropertyCasCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoPropertyCasCreateRequest(){}
	
	public IpfCcmBoPropertyCasCreateRequest(IpfCcmBoPropertyCas ipfCcmBoPropertyCas){
	...
	public static List<IpfCcmBoPropertyCas> cloneBOList(List<IpfCcmBoPropertyCasCreateRequest> vos){
		...
		for(IpfCcmBoPropertyCasCreateRequest vo: vos){
