...
public class IpfCcmBizruleSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBizruleSelectRequest(){}
	
	public IpfCcmBizruleSelectRequest(IpfCcmBizrule ipfCcmBizrule){
	...
	public static List<IpfCcmBizrule> cloneBOList(List<IpfCcmBizruleSelectRequest> vos){
		...
		for(IpfCcmBizruleSelectRequest vo: vos){
