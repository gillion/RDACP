...
public class IpfFciBuildCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfFciBuildCreateRequest(){}
	
	public IpfFciBuildCreateRequest(IpfFciBuild ipfFciBuild){
