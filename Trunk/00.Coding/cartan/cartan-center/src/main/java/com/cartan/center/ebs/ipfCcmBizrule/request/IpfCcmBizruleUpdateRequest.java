...
public class IpfCcmBizruleUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBizruleUpdateRequest(){}
	
	public IpfCcmBizruleUpdateRequest(IpfCcmBizrule ipfCcmBizrule){
	...
	public static List<IpfCcmBizrule> cloneBOList(List<IpfCcmBizruleUpdateRequest> vos){
		...
		for(IpfCcmBizruleUpdateRequest vo: vos){
