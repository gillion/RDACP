...
public class IpfDmlIndexSelectRequest extends AbstractRopRequest {
	...
	public IpfDmlIndexSelectRequest(){}
	
	public IpfDmlIndexSelectRequest(IpfDmlIndex ipfDmlIndex){
