...
public class IpfCcmUiLayoutListUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmUiLayoutListUpdateRequest(){}
	
	public IpfCcmUiLayoutListUpdateRequest(IpfCcmUiLayoutList ipfCcmUiLayoutList){
	...
	public static List<IpfCcmUiLayoutList> cloneBOList(List<IpfCcmUiLayoutListUpdateRequest> vos){
		...
		for(IpfCcmUiLayoutListUpdateRequest vo: vos){
