...
public class IpfCcmBoCheckGroupSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoCheckGroupSelectRequest(){}
	
	public IpfCcmBoCheckGroupSelectRequest(IpfCcmBoCheckGroup ipfCcmBoCheckGroup){
	...
	public static List<IpfCcmBoCheckGroup> cloneBOList(List<IpfCcmBoCheckGroupSelectRequest> vos){
		...
		for(IpfCcmBoCheckGroupSelectRequest vo: vos){
