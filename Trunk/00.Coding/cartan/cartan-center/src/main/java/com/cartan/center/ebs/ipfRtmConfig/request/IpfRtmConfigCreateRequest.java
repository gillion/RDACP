...
public class IpfRtmConfigCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRtmConfigCreateRequest(){}
	
	public IpfRtmConfigCreateRequest(IpfRtmConfig ipfRtmConfig){
