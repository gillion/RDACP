...
public class IpfCcmDictUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmDictUpdateRequest(){}
	
	public IpfCcmDictUpdateRequest(IpfCcmDict ipfCcmDict){
