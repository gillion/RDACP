...
public class IpfCcmNumruleListCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmNumruleListCreateRequest(){}
	
	public IpfCcmNumruleListCreateRequest(IpfCcmNumruleList ipfCcmNumruleList){
	...
	public static List<IpfCcmNumruleList> cloneBOList(List<IpfCcmNumruleListCreateRequest> vos){
		...
		for(IpfCcmNumruleListCreateRequest vo: vos){
