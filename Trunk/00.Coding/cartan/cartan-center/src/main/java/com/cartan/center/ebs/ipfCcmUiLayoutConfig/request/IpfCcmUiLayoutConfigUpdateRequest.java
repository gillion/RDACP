...
public class IpfCcmUiLayoutConfigUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmUiLayoutConfigUpdateRequest(){}
	
	public IpfCcmUiLayoutConfigUpdateRequest(IpfCcmUiLayoutConfig ipfCcmUiLayoutConfig){
	...
	public static List<IpfCcmUiLayoutConfig> cloneBOList(List<IpfCcmUiLayoutConfigUpdateRequest> vos){
		...
		for(IpfCcmUiLayoutConfigUpdateRequest vo: vos){
