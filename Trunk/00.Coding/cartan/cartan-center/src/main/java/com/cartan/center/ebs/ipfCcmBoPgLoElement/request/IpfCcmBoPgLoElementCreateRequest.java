...
public class IpfCcmBoPgLoElementCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoPgLoElementCreateRequest(){}
	
	public IpfCcmBoPgLoElementCreateRequest(IpfCcmBoPgLoElement ipfCcmBoPgLoElement){
	...
	public static List<IpfCcmBoPgLoElement> cloneBOList(List<IpfCcmBoPgLoElementCreateRequest> vos){
		...
		for(IpfCcmBoPgLoElementCreateRequest vo: vos){
