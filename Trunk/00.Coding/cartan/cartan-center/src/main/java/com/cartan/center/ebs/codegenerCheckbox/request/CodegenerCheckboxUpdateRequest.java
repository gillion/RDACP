...
public class CodegenerCheckboxUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public CodegenerCheckboxUpdateRequest(){}
	
	public CodegenerCheckboxUpdateRequest(CodegenerCheckbox codegenerCheckbox){
	...
	public static List<CodegenerCheckbox> cloneBOList(List<CodegenerCheckboxUpdateRequest> vos){
		...
		for(CodegenerCheckboxUpdateRequest vo: vos){
