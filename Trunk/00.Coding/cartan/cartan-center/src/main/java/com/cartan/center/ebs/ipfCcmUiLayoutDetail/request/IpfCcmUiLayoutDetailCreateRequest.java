...
public class IpfCcmUiLayoutDetailCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmUiLayoutDetailCreateRequest(){}
	
	public IpfCcmUiLayoutDetailCreateRequest(IpfCcmUiLayoutDetail ipfCcmUiLayoutDetail){
	...
	public static List<IpfCcmUiLayoutDetail> cloneBOList(List<IpfCcmUiLayoutDetailCreateRequest> vos){
		...
		for(IpfCcmUiLayoutDetailCreateRequest vo: vos){
