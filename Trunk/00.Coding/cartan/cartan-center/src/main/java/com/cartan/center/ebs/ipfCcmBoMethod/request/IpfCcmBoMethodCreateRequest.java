...
public class IpfCcmBoMethodCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoMethodCreateRequest(){}
	
	public IpfCcmBoMethodCreateRequest(IpfCcmBoMethod ipfCcmBoMethod){
	...
	public static List<IpfCcmBoMethod> cloneBOList(List<IpfCcmBoMethodCreateRequest> vos){
		...
		for(IpfCcmBoMethodCreateRequest vo: vos){
