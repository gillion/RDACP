...
public class IpfCcmBoControlEventCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoControlEventCreateRequest(){}
	
	public IpfCcmBoControlEventCreateRequest(IpfCcmBoControlEvent ipfCcmBoControlEvent){
	...
	public static List<IpfCcmBoControlEvent> cloneBOList(List<IpfCcmBoControlEventCreateRequest> vos){
		...
		for(IpfCcmBoControlEventCreateRequest vo: vos){
