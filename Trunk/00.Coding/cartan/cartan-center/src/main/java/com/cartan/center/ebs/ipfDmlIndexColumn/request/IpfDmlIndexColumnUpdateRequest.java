...
public class IpfDmlIndexColumnUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlIndexColumnUpdateRequest(){}
	
	public IpfDmlIndexColumnUpdateRequest(IpfDmlIndexColumn ipfDmlIndexColumn){
	...
	public static List<IpfDmlIndexColumn> cloneBOList(List<IpfDmlIndexColumnUpdateRequest> vos){
		...
		for(IpfDmlIndexColumnUpdateRequest vo: vos){
