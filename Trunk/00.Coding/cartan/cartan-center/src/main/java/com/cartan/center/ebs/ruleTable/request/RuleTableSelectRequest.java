...
public class RuleTableSelectRequest extends AbstractRopRequest {
	...
	public RuleTableSelectRequest(){}
	
	public RuleTableSelectRequest(RuleTable ruleTable){
