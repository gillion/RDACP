...
public class IpfCcmDictValueCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmDictValueCreateRequest(){}
	
	public IpfCcmDictValueCreateRequest(IpfCcmDictValue ipfCcmDictValue){
	...
	public static List<IpfCcmDictValue> cloneBOList(List<IpfCcmDictValueCreateRequest> vos){
		...
		for(IpfCcmDictValueCreateRequest vo: vos){
