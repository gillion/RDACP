...
public class CodegenerSelectUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public CodegenerSelectUpdateRequest(){}
	
	public CodegenerSelectUpdateRequest(CodegenerSelect codegenerSelect){
	...
	public static List<CodegenerSelect> cloneBOList(List<CodegenerSelectUpdateRequest> vos){
		...
		for(CodegenerSelectUpdateRequest vo: vos){
