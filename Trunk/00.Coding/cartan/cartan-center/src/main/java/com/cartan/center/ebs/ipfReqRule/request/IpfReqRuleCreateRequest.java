...
public class IpfReqRuleCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfReqRuleCreateRequest(){}
	
	public IpfReqRuleCreateRequest(IpfReqRule ipfReqRule){
