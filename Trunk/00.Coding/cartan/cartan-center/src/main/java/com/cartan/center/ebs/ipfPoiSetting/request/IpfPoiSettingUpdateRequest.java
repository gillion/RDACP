...
public class IpfPoiSettingUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfPoiSettingUpdateRequest(){}
	
	public IpfPoiSettingUpdateRequest(IpfPoiSetting ipfPoiSetting){
	...
	public static List<IpfPoiSetting> cloneBOList(List<IpfPoiSettingUpdateRequest> vos){
		...
		for(IpfPoiSettingUpdateRequest vo: vos){
