...
public class IpfCcmUiLayoutConfigSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmUiLayoutConfigSelectRequest(){}
	
	public IpfCcmUiLayoutConfigSelectRequest(IpfCcmUiLayoutConfig ipfCcmUiLayoutConfig){
	...
	public static List<IpfCcmUiLayoutConfig> cloneBOList(List<IpfCcmUiLayoutConfigSelectRequest> vos){
		...
		for(IpfCcmUiLayoutConfigSelectRequest vo: vos){
