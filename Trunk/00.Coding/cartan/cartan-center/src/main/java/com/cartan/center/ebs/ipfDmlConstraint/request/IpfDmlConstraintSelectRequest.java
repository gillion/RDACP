...
public class IpfDmlConstraintSelectRequest extends AbstractRopRequest {
	...
	public IpfDmlConstraintSelectRequest(){}
	
	public IpfDmlConstraintSelectRequest(IpfDmlConstraint ipfDmlConstraint){
	...
	public static List<IpfDmlConstraint> cloneBOList(List<IpfDmlConstraintSelectRequest> vos){
		...
		for(IpfDmlConstraintSelectRequest vo: vos){
