...
public class CodegenerTableSelectRequest extends AbstractRopRequest {
	...
	public CodegenerTableSelectRequest(){}
	
	public CodegenerTableSelectRequest(CodegenerTable codegenerTable){
	...
	public static List<CodegenerTable> cloneBOList(List<CodegenerTableSelectRequest> vos){
		...
		for(CodegenerTableSelectRequest vo: vos){
