...
public class GroupInfoCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public GroupInfoCreateRequest(){}
	
	public GroupInfoCreateRequest(GroupInfo groupInfo){
