...
public class IpfCcmStrategyUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmStrategyUpdateRequest(){}
	
	public IpfCcmStrategyUpdateRequest(IpfCcmStrategy ipfCcmStrategy){
	...
	public static List<IpfCcmStrategy> cloneBOList(List<IpfCcmStrategyUpdateRequest> vos){
		...
		for(IpfCcmStrategyUpdateRequest vo: vos){
