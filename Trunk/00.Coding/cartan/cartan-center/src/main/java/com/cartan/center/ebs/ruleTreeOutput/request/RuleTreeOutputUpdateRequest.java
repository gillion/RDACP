...
public class RuleTreeOutputUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public RuleTreeOutputUpdateRequest(){}
	
	public RuleTreeOutputUpdateRequest(RuleTreeOutput ruleTreeOutput){
	...
	public static List<RuleTreeOutput> cloneBOList(List<RuleTreeOutputUpdateRequest> vos){
		...
		for(RuleTreeOutputUpdateRequest vo: vos){
