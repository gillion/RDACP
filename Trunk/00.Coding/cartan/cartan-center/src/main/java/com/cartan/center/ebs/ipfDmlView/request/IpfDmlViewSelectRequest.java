...
public class IpfDmlViewSelectRequest extends AbstractRopRequest {
	...
	public IpfDmlViewSelectRequest(){}
	
	public IpfDmlViewSelectRequest(IpfDmlView ipfDmlView){
