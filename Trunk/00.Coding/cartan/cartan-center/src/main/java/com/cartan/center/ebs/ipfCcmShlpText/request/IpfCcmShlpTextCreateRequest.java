...
public class IpfCcmShlpTextCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmShlpTextCreateRequest(){}
	
	public IpfCcmShlpTextCreateRequest(IpfCcmShlpText ipfCcmShlpText){
	...
	public static List<IpfCcmShlpText> cloneBOList(List<IpfCcmShlpTextCreateRequest> vos){
		...
		for(IpfCcmShlpTextCreateRequest vo: vos){
