...
public class IpfRtmTypeBoAttrCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRtmTypeBoAttrCreateRequest(){}
	
	public IpfRtmTypeBoAttrCreateRequest(IpfRtmTypeBoAttr ipfRtmTypeBoAttr){
	...
	public static List<IpfRtmTypeBoAttr> cloneBOList(List<IpfRtmTypeBoAttrCreateRequest> vos){
		...
		for(IpfRtmTypeBoAttrCreateRequest vo: vos){
