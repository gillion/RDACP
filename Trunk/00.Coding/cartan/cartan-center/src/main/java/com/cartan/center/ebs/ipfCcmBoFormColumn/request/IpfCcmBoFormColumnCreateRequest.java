...
public class IpfCcmBoFormColumnCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoFormColumnCreateRequest(){}
	
	public IpfCcmBoFormColumnCreateRequest(IpfCcmBoFormColumn ipfCcmBoFormColumn){
	...
	public static List<IpfCcmBoFormColumn> cloneBOList(List<IpfCcmBoFormColumnCreateRequest> vos){
		...
		for(IpfCcmBoFormColumnCreateRequest vo: vos){
