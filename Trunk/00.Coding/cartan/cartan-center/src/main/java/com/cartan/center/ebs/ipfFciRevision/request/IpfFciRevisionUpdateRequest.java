...
public class IpfFciRevisionUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfFciRevisionUpdateRequest(){}
	
	public IpfFciRevisionUpdateRequest(IpfFciRevision ipfFciRevision){
	...
	public static List<IpfFciRevision> cloneBOList(List<IpfFciRevisionUpdateRequest> vos){
		...
		for(IpfFciRevisionUpdateRequest vo: vos){
