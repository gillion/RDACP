...
public class IpfRuleFilterUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRuleFilterUpdateRequest(){}
	
	public IpfRuleFilterUpdateRequest(IpfRuleFilter ipfRuleFilter){
	...
	public static List<IpfRuleFilter> cloneBOList(List<IpfRuleFilterUpdateRequest> vos){
		...
		for(IpfRuleFilterUpdateRequest vo: vos){
