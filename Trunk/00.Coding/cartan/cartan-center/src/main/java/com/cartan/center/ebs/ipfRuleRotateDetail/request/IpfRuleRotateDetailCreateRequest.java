...
public class IpfRuleRotateDetailCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRuleRotateDetailCreateRequest(){}
	
	public IpfRuleRotateDetailCreateRequest(IpfRuleRotateDetail ipfRuleRotateDetail){
	...
	public static List<IpfRuleRotateDetail> cloneBOList(List<IpfRuleRotateDetailCreateRequest> vos){
		...
		for(IpfRuleRotateDetailCreateRequest vo: vos){
