...
public class IpfDmlTableCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlTableCreateRequest(){}
	
	public IpfDmlTableCreateRequest(IpfDmlTable ipfDmlTable){
