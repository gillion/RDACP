...
public class IpfRtmConfigAttrBoSelectRequest extends AbstractRopRequest {
	...
	public IpfRtmConfigAttrBoSelectRequest(){}
	
	public IpfRtmConfigAttrBoSelectRequest(IpfRtmConfigAttrBo ipfRtmConfigAttrBo){
	...
	public static List<IpfRtmConfigAttrBo> cloneBOList(List<IpfRtmConfigAttrBoSelectRequest> vos){
		...
		for(IpfRtmConfigAttrBoSelectRequest vo: vos){
