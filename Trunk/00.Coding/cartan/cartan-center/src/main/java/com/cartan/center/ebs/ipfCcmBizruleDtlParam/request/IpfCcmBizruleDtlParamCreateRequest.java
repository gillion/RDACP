...
public class IpfCcmBizruleDtlParamCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBizruleDtlParamCreateRequest(){}
	
	public IpfCcmBizruleDtlParamCreateRequest(IpfCcmBizruleDtlParam ipfCcmBizruleDtlParam){
	...
	public static List<IpfCcmBizruleDtlParam> cloneBOList(List<IpfCcmBizruleDtlParamCreateRequest> vos){
		...
		for(IpfCcmBizruleDtlParamCreateRequest vo: vos){
