...
public class IpfCcmBoGridToolbarCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoGridToolbarCreateRequest(){}
	
	public IpfCcmBoGridToolbarCreateRequest(IpfCcmBoGridToolbar ipfCcmBoGridToolbar){
	...
	public static List<IpfCcmBoGridToolbar> cloneBOList(List<IpfCcmBoGridToolbarCreateRequest> vos){
		...
		for(IpfCcmBoGridToolbarCreateRequest vo: vos){
