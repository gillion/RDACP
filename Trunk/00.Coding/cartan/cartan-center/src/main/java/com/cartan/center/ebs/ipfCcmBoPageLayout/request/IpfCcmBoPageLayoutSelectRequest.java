...
public class IpfCcmBoPageLayoutSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoPageLayoutSelectRequest(){}
	
	public IpfCcmBoPageLayoutSelectRequest(IpfCcmBoPageLayout ipfCcmBoPageLayout){
	...
	public static List<IpfCcmBoPageLayout> cloneBOList(List<IpfCcmBoPageLayoutSelectRequest> vos){
		...
		for(IpfCcmBoPageLayoutSelectRequest vo: vos){
