...
public class IpfPoiSettingCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfPoiSettingCreateRequest(){}
	
	public IpfPoiSettingCreateRequest(IpfPoiSetting ipfPoiSetting){
	...
	public static List<IpfPoiSetting> cloneBOList(List<IpfPoiSettingCreateRequest> vos){
		...
		for(IpfPoiSettingCreateRequest vo: vos){
