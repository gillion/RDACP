...
public class GroupInfoSelectRequest extends AbstractRopRequest {
	...
	public GroupInfoSelectRequest(){}
	
	public GroupInfoSelectRequest(GroupInfo groupInfo){
