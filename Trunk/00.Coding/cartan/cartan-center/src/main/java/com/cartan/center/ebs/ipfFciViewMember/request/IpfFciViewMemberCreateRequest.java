...
public class IpfFciViewMemberCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfFciViewMemberCreateRequest(){}
	
	public IpfFciViewMemberCreateRequest(IpfFciViewMember ipfFciViewMember){
	...
	public static List<IpfFciViewMember> cloneBOList(List<IpfFciViewMemberCreateRequest> vos){
		...
		for(IpfFciViewMemberCreateRequest vo: vos){
