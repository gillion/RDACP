...
public class IpfReqRuleUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfReqRuleUpdateRequest(){}
	
	public IpfReqRuleUpdateRequest(IpfReqRule ipfReqRule){
