...
public class IpfFciViewMemberSelectRequest extends AbstractRopRequest {
	...
	public IpfFciViewMemberSelectRequest(){}
	
	public IpfFciViewMemberSelectRequest(IpfFciViewMember ipfFciViewMember){
	...
	public static List<IpfFciViewMember> cloneBOList(List<IpfFciViewMemberSelectRequest> vos){
		...
		for(IpfFciViewMemberSelectRequest vo: vos){
