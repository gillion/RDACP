...
public class IpfRtmConfigAttrBoCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRtmConfigAttrBoCreateRequest(){}
	
	public IpfRtmConfigAttrBoCreateRequest(IpfRtmConfigAttrBo ipfRtmConfigAttrBo){
	...
	public static List<IpfRtmConfigAttrBo> cloneBOList(List<IpfRtmConfigAttrBoCreateRequest> vos){
		...
		for(IpfRtmConfigAttrBoCreateRequest vo: vos){
