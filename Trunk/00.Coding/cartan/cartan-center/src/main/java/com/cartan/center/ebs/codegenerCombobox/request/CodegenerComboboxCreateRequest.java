...
public class CodegenerComboboxCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public CodegenerComboboxCreateRequest(){}
	
	public CodegenerComboboxCreateRequest(CodegenerCombobox codegenerCombobox){
	...
	public static List<CodegenerCombobox> cloneBOList(List<CodegenerComboboxCreateRequest> vos){
		...
		for(CodegenerComboboxCreateRequest vo: vos){
