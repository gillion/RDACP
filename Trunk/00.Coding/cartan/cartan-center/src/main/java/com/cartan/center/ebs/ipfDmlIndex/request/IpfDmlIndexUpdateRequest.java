...
public class IpfDmlIndexUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlIndexUpdateRequest(){}
	
	public IpfDmlIndexUpdateRequest(IpfDmlIndex ipfDmlIndex){
