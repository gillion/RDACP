...
public class IpfDmlColumnCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlColumnCreateRequest(){}
	
	public IpfDmlColumnCreateRequest(IpfDmlColumn ipfDmlColumn){
