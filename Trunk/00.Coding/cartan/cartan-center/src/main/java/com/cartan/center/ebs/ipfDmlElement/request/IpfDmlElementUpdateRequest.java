...
public class IpfDmlElementUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlElementUpdateRequest(){}
	
	public IpfDmlElementUpdateRequest(IpfDmlElement ipfDmlElement){
	...
	public static List<IpfDmlElement> cloneBOList(List<IpfDmlElementUpdateRequest> vos){
		...
		for(IpfDmlElementUpdateRequest vo: vos){
