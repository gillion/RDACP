...
public class IpfRtmTypeUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRtmTypeUpdateRequest(){}
	
	public IpfRtmTypeUpdateRequest(IpfRtmType ipfRtmType){
