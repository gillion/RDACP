...
public class ComstyleCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public ComstyleCreateRequest(){}
	
	public ComstyleCreateRequest(Comstyle comstyle){
