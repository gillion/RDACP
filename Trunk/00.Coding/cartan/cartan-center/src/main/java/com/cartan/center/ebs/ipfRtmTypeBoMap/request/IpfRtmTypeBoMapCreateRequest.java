...
public class IpfRtmTypeBoMapCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRtmTypeBoMapCreateRequest(){}
	
	public IpfRtmTypeBoMapCreateRequest(IpfRtmTypeBoMap ipfRtmTypeBoMap){
	...
	public static List<IpfRtmTypeBoMap> cloneBOList(List<IpfRtmTypeBoMapCreateRequest> vos){
		...
		for(IpfRtmTypeBoMapCreateRequest vo: vos){
