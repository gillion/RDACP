...
public class IpfCcmUiLayoutCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmUiLayoutCreateRequest(){}
	
	public IpfCcmUiLayoutCreateRequest(IpfCcmUiLayout ipfCcmUiLayout){
	...
	public static List<IpfCcmUiLayout> cloneBOList(List<IpfCcmUiLayoutCreateRequest> vos){
		...
		for(IpfCcmUiLayoutCreateRequest vo: vos){
