...
public class IpfCcmBoPageSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoPageSelectRequest(){}
	
	public IpfCcmBoPageSelectRequest(IpfCcmBoPage ipfCcmBoPage){
