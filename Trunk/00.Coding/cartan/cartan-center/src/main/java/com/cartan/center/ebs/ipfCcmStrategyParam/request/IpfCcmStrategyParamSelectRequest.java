...
public class IpfCcmStrategyParamSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmStrategyParamSelectRequest(){}
	
	public IpfCcmStrategyParamSelectRequest(IpfCcmStrategyParam ipfCcmStrategyParam){
	...
	public static List<IpfCcmStrategyParam> cloneBOList(List<IpfCcmStrategyParamSelectRequest> vos){
		...
		for(IpfCcmStrategyParamSelectRequest vo: vos){
