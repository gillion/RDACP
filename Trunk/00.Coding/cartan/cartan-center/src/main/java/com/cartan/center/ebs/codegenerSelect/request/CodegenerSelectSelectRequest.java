...
public class CodegenerSelectSelectRequest extends AbstractRopRequest {
	...
	public CodegenerSelectSelectRequest(){}
	
	public CodegenerSelectSelectRequest(CodegenerSelect codegenerSelect){
	...
	public static List<CodegenerSelect> cloneBOList(List<CodegenerSelectSelectRequest> vos){
		...
		for(CodegenerSelectSelectRequest vo: vos){
