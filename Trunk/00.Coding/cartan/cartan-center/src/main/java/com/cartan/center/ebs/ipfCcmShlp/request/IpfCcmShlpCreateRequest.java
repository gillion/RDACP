...
public class IpfCcmShlpCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmShlpCreateRequest(){}
	
	public IpfCcmShlpCreateRequest(IpfCcmShlp ipfCcmShlp){
