...
public class LoginUserCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public LoginUserCreateRequest(){}
	
	public LoginUserCreateRequest(LoginUser loginUser){
