...
public class MemberVoteCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public MemberVoteCreateRequest(){}
	
	public MemberVoteCreateRequest(MemberVote memberVote){
