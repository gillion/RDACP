...
public class GroupMemberUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 200)
	...
	public GroupMemberUpdateRequest(GroupMember groupMember){
