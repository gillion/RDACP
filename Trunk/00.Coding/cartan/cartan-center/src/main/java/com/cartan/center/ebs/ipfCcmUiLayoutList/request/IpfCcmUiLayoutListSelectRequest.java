...
public class IpfCcmUiLayoutListSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmUiLayoutListSelectRequest(){}
	
	public IpfCcmUiLayoutListSelectRequest(IpfCcmUiLayoutList ipfCcmUiLayoutList){
	...
	public static List<IpfCcmUiLayoutList> cloneBOList(List<IpfCcmUiLayoutListSelectRequest> vos){
		...
		for(IpfCcmUiLayoutListSelectRequest vo: vos){
