...
public class IpfFciLabelSelectRequest extends AbstractRopRequest {
	...
	public IpfFciLabelSelectRequest(){}
	
	public IpfFciLabelSelectRequest(IpfFciLabel ipfFciLabel){
