...
public class IpfCcmEnvironmentSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmEnvironmentSelectRequest(){}
	
	public IpfCcmEnvironmentSelectRequest(IpfCcmEnvironment ipfCcmEnvironment){
	...
	public static List<IpfCcmEnvironment> cloneBOList(List<IpfCcmEnvironmentSelectRequest> vos){
		...
		for(IpfCcmEnvironmentSelectRequest vo: vos){
