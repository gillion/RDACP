...
public class IpfCcmBoCheckCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoCheckCreateRequest(){}
	
	public IpfCcmBoCheckCreateRequest(IpfCcmBoCheck ipfCcmBoCheck){
	...
	public static List<IpfCcmBoCheck> cloneBOList(List<IpfCcmBoCheckCreateRequest> vos){
		...
		for(IpfCcmBoCheckCreateRequest vo: vos){
