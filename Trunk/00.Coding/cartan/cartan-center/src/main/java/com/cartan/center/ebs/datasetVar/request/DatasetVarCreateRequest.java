...
public class DatasetVarCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public DatasetVarCreateRequest(){}
	
	public DatasetVarCreateRequest(DatasetVar datasetVar){
