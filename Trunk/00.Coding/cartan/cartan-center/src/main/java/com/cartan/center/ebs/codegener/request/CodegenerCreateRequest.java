...
public class CodegenerCreateRequest extends AbstractRopRequest {
	...
	public CodegenerCreateRequest(){}
	
	public CodegenerCreateRequest(Codegener codegener){
