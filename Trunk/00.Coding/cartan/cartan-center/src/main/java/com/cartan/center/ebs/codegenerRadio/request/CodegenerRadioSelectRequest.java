...
public class CodegenerRadioSelectRequest extends AbstractRopRequest {
	...
	public CodegenerRadioSelectRequest(){}
	
	public CodegenerRadioSelectRequest(CodegenerRadio codegenerRadio){
	...
	public static List<CodegenerRadio> cloneBOList(List<CodegenerRadioSelectRequest> vos){
		...
		for(CodegenerRadioSelectRequest vo: vos){
