...
public class GroupActionSelectRequest extends AbstractRopRequest {
	...
	public GroupActionSelectRequest(){}
	
	public GroupActionSelectRequest(GroupAction groupAction){
