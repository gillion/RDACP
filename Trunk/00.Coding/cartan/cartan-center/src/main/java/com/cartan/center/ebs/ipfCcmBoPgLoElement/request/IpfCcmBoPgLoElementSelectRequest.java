...
public class IpfCcmBoPgLoElementSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoPgLoElementSelectRequest(){}
	
	public IpfCcmBoPgLoElementSelectRequest(IpfCcmBoPgLoElement ipfCcmBoPgLoElement){
	...
	public static List<IpfCcmBoPgLoElement> cloneBOList(List<IpfCcmBoPgLoElementSelectRequest> vos){
		...
		for(IpfCcmBoPgLoElementSelectRequest vo: vos){
