...
public class IpfDmlColumnSelectRequest extends AbstractRopRequest {
	...
	public IpfDmlColumnSelectRequest(){}
	
	public IpfDmlColumnSelectRequest(IpfDmlColumn ipfDmlColumn){
