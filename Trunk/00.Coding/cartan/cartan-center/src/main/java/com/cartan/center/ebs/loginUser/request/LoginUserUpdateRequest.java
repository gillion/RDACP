...
public class LoginUserUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public LoginUserUpdateRequest(){}
	
	public LoginUserUpdateRequest(LoginUser loginUser){
