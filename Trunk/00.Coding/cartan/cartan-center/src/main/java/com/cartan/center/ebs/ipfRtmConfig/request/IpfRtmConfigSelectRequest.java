...
public class IpfRtmConfigSelectRequest extends AbstractRopRequest {
	...
	public IpfRtmConfigSelectRequest(){}
	
	public IpfRtmConfigSelectRequest(IpfRtmConfig ipfRtmConfig){
