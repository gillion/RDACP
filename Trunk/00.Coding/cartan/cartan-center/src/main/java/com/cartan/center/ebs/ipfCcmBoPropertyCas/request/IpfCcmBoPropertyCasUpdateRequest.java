...
public class IpfCcmBoPropertyCasUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoPropertyCasUpdateRequest(){}
	
	public IpfCcmBoPropertyCasUpdateRequest(IpfCcmBoPropertyCas ipfCcmBoPropertyCas){
	...
	public static List<IpfCcmBoPropertyCas> cloneBOList(List<IpfCcmBoPropertyCasUpdateRequest> vos){
		...
		for(IpfCcmBoPropertyCasUpdateRequest vo: vos){
