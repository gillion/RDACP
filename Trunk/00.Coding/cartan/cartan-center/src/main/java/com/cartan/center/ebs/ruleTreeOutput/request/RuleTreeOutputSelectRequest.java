...
public class RuleTreeOutputSelectRequest extends AbstractRopRequest {
	...
	public RuleTreeOutputSelectRequest(){}
	
	public RuleTreeOutputSelectRequest(RuleTreeOutput ruleTreeOutput){
	...
	public static List<RuleTreeOutput> cloneBOList(List<RuleTreeOutputSelectRequest> vos){
		...
		for(RuleTreeOutputSelectRequest vo: vos){
