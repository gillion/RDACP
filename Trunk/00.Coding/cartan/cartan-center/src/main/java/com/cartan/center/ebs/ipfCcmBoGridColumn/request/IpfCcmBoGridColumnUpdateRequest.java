...
public class IpfCcmBoGridColumnUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoGridColumnUpdateRequest(){}
	
	public IpfCcmBoGridColumnUpdateRequest(IpfCcmBoGridColumn ipfCcmBoGridColumn){
	...
	public static List<IpfCcmBoGridColumn> cloneBOList(List<IpfCcmBoGridColumnUpdateRequest> vos){
		...
		for(IpfCcmBoGridColumnUpdateRequest vo: vos){
