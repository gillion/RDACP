...
public class IpfRuleFilterDetailUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRuleFilterDetailUpdateRequest(){}
	
	public IpfRuleFilterDetailUpdateRequest(IpfRuleFilterDetail ipfRuleFilterDetail){
	...
	public static List<IpfRuleFilterDetail> cloneBOList(List<IpfRuleFilterDetailUpdateRequest> vos){
		...
		for(IpfRuleFilterDetailUpdateRequest vo: vos){
