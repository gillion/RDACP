...
public class IpfCcmBoControlEventUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoControlEventUpdateRequest(){}
	
	public IpfCcmBoControlEventUpdateRequest(IpfCcmBoControlEvent ipfCcmBoControlEvent){
	...
	public static List<IpfCcmBoControlEvent> cloneBOList(List<IpfCcmBoControlEventUpdateRequest> vos){
		...
		for(IpfCcmBoControlEventUpdateRequest vo: vos){
