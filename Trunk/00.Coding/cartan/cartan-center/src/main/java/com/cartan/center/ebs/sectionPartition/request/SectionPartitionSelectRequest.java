...
public class SectionPartitionSelectRequest extends AbstractRopRequest {
	...
	public SectionPartitionSelectRequest(){}
	
	public SectionPartitionSelectRequest(SectionPartition sectionPartition){
	...
	public static List<SectionPartition> cloneBOList(List<SectionPartitionSelectRequest> vos){
		...
		for(SectionPartitionSelectRequest vo: vos){
