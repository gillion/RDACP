...
public class IpfCcmBoPageLayoutCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoPageLayoutCreateRequest(){}
	
	public IpfCcmBoPageLayoutCreateRequest(IpfCcmBoPageLayout ipfCcmBoPageLayout){
	...
	public static List<IpfCcmBoPageLayout> cloneBOList(List<IpfCcmBoPageLayoutCreateRequest> vos){
		...
		for(IpfCcmBoPageLayoutCreateRequest vo: vos){
