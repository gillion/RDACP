...
public class IpfFciLabelDetailSelectRequest extends AbstractRopRequest {
	...
	public IpfFciLabelDetailSelectRequest(){}
	
	public IpfFciLabelDetailSelectRequest(IpfFciLabelDetail ipfFciLabelDetail){
	...
	public static List<IpfFciLabelDetail> cloneBOList(List<IpfFciLabelDetailSelectRequest> vos){
		...
		for(IpfFciLabelDetailSelectRequest vo: vos){
