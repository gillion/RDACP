...
public class ConditionPartitionCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public ConditionPartitionCreateRequest(){}
	
	public ConditionPartitionCreateRequest(ConditionPartition conditionPartition){
	...
	public static List<ConditionPartition> cloneBOList(List<ConditionPartitionCreateRequest> vos){
		...
		for(ConditionPartitionCreateRequest vo: vos){
