...
public class IpfDmlConstraintColumnUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlConstraintColumnUpdateRequest(){}
	
	public IpfDmlConstraintColumnUpdateRequest(IpfDmlConstraintColumn ipfDmlConstraintColumn){
	...
	public static List<IpfDmlConstraintColumn> cloneBOList(List<IpfDmlConstraintColumnUpdateRequest> vos){
		...
		for(IpfDmlConstraintColumnUpdateRequest vo: vos){
