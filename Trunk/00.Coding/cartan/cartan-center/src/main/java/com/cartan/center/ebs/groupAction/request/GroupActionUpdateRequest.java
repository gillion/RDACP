...
public class GroupActionUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public GroupActionUpdateRequest(){}
	
	public GroupActionUpdateRequest(GroupAction groupAction){
