...
public class IpfCcmBoPageCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoPageCreateRequest(){}
	
	public IpfCcmBoPageCreateRequest(IpfCcmBoPage ipfCcmBoPage){
