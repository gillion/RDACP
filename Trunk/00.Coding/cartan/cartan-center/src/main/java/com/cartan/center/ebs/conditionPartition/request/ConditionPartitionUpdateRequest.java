...
public class ConditionPartitionUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public ConditionPartitionUpdateRequest(){}
	
	public ConditionPartitionUpdateRequest(ConditionPartition conditionPartition){
	...
	public static List<ConditionPartition> cloneBOList(List<ConditionPartitionUpdateRequest> vos){
		...
		for(ConditionPartitionUpdateRequest vo: vos){
