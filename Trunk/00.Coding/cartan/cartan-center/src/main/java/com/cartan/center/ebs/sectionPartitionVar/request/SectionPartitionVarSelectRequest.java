...
public class SectionPartitionVarSelectRequest extends AbstractRopRequest {
	...
	public SectionPartitionVarSelectRequest(){}
	
	public SectionPartitionVarSelectRequest(SectionPartitionVar sectionPartitionVar){
	...
	public static List<SectionPartitionVar> cloneBOList(List<SectionPartitionVarSelectRequest> vos){
		...
		for(SectionPartitionVarSelectRequest vo: vos){
