...
public class IpfCcmBizruleDtlUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBizruleDtlUpdateRequest(){}
	
	public IpfCcmBizruleDtlUpdateRequest(IpfCcmBizruleDtl ipfCcmBizruleDtl){
	...
	public static List<IpfCcmBizruleDtl> cloneBOList(List<IpfCcmBizruleDtlUpdateRequest> vos){
		...
		for(IpfCcmBizruleDtlUpdateRequest vo: vos){
