...
public class IpfCcmBoRelationUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoRelationUpdateRequest(){}
	
	public IpfCcmBoRelationUpdateRequest(IpfCcmBoRelation ipfCcmBoRelation){
	...
	public static List<IpfCcmBoRelation> cloneBOList(List<IpfCcmBoRelationUpdateRequest> vos){
		...
		for(IpfCcmBoRelationUpdateRequest vo: vos){
