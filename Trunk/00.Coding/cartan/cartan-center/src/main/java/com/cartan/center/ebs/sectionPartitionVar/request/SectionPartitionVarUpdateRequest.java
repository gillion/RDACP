...
public class SectionPartitionVarUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public SectionPartitionVarUpdateRequest(){}
	
	public SectionPartitionVarUpdateRequest(SectionPartitionVar sectionPartitionVar){
	...
	public static List<SectionPartitionVar> cloneBOList(List<SectionPartitionVarUpdateRequest> vos){
		...
		for(SectionPartitionVarUpdateRequest vo: vos){
