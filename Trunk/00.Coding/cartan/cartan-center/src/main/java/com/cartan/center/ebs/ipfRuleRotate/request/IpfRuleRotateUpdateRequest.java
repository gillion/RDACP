...
public class IpfRuleRotateUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRuleRotateUpdateRequest(){}
	
	public IpfRuleRotateUpdateRequest(IpfRuleRotate ipfRuleRotate){
	...
	public static List<IpfRuleRotate> cloneBOList(List<IpfRuleRotateUpdateRequest> vos){
		...
		for(IpfRuleRotateUpdateRequest vo: vos){
