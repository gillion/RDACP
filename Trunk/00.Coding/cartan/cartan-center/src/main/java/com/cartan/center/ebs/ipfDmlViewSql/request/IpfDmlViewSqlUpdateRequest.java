...
public class IpfDmlViewSqlUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlViewSqlUpdateRequest(){}
	
	public IpfDmlViewSqlUpdateRequest(IpfDmlViewSql ipfDmlViewSql){
	...
	public static List<IpfDmlViewSql> cloneBOList(List<IpfDmlViewSqlUpdateRequest> vos){
		...
		for(IpfDmlViewSqlUpdateRequest vo: vos){
