...
public class RuleTableOutputUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public RuleTableOutputUpdateRequest(){}
	
	public RuleTableOutputUpdateRequest(RuleTableOutput ruleTableOutput){
	...
	public static List<RuleTableOutput> cloneBOList(List<RuleTableOutputUpdateRequest> vos){
		...
		for(RuleTableOutputUpdateRequest vo: vos){
