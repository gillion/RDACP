...
public class IpfRtmTypeSelectRequest extends AbstractRopRequest {
	...
	public IpfRtmTypeSelectRequest(){}
	
	public IpfRtmTypeSelectRequest(IpfRtmType ipfRtmType){
