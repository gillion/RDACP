...
public class IpfCcmShlpTextSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmShlpTextSelectRequest(){}
	
	public IpfCcmShlpTextSelectRequest(IpfCcmShlpText ipfCcmShlpText){
	...
	public static List<IpfCcmShlpText> cloneBOList(List<IpfCcmShlpTextSelectRequest> vos){
		...
		for(IpfCcmShlpTextSelectRequest vo: vos){
