...
public class IpfFciLabelCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfFciLabelCreateRequest(){}
	
	public IpfFciLabelCreateRequest(IpfFciLabel ipfFciLabel){
