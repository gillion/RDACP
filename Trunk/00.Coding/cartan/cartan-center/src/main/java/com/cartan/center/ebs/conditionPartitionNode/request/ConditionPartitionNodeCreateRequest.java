...
public class ConditionPartitionNodeCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public ConditionPartitionNodeCreateRequest(){}
	
	public ConditionPartitionNodeCreateRequest(ConditionPartitionNode conditionPartitionNode){
	...
	public static List<ConditionPartitionNode> cloneBOList(List<ConditionPartitionNodeCreateRequest> vos){
		...
		for(ConditionPartitionNodeCreateRequest vo: vos){
