...
public class IpfRuleFilterCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfRuleFilterCreateRequest(){}
	
	public IpfRuleFilterCreateRequest(IpfRuleFilter ipfRuleFilter){
	...
	public static List<IpfRuleFilter> cloneBOList(List<IpfRuleFilterCreateRequest> vos){
		...
		for(IpfRuleFilterCreateRequest vo: vos){
