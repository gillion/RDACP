...
public class RuleTreeUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public RuleTreeUpdateRequest(){}
	
	public RuleTreeUpdateRequest(RuleTree ruleTree){
