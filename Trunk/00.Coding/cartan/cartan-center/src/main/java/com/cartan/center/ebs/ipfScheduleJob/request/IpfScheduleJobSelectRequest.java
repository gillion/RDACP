...
public class IpfScheduleJobSelectRequest extends AbstractRopRequest {
	...
	public IpfScheduleJobSelectRequest(){}
	
	public IpfScheduleJobSelectRequest(IpfScheduleJob ipfScheduleJob){
	...
	public static List<IpfScheduleJob> cloneBOList(List<IpfScheduleJobSelectRequest> vos){
		...
		for(IpfScheduleJobSelectRequest vo: vos){
