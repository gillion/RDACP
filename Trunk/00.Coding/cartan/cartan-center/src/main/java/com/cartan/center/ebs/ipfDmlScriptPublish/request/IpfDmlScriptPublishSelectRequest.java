...
public class IpfDmlScriptPublishSelectRequest extends AbstractRopRequest {
	...
	public IpfDmlScriptPublishSelectRequest(){}
	
	public IpfDmlScriptPublishSelectRequest(IpfDmlScriptPublish ipfDmlScriptPublish){
	...
	public static List<IpfDmlScriptPublish> cloneBOList(List<IpfDmlScriptPublishSelectRequest> vos){
		...
		for(IpfDmlScriptPublishSelectRequest vo: vos){
