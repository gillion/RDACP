...
public class IpfCcmBoCheckSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoCheckSelectRequest(){}
	
	public IpfCcmBoCheckSelectRequest(IpfCcmBoCheck ipfCcmBoCheck){
	...
	public static List<IpfCcmBoCheck> cloneBOList(List<IpfCcmBoCheckSelectRequest> vos){
		...
		for(IpfCcmBoCheckSelectRequest vo: vos){
