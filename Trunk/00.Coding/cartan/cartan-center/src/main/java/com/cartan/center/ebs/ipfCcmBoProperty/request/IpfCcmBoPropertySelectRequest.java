...
public class IpfCcmBoPropertySelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoPropertySelectRequest(){}
	
	public IpfCcmBoPropertySelectRequest(IpfCcmBoProperty ipfCcmBoProperty){
	...
	public static List<IpfCcmBoProperty> cloneBOList(List<IpfCcmBoPropertySelectRequest> vos){
		...
		for(IpfCcmBoPropertySelectRequest vo: vos){
