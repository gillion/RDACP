...
public class IpfCcmShlpSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmShlpSelectRequest(){}
	
	public IpfCcmShlpSelectRequest(IpfCcmShlp ipfCcmShlp){
