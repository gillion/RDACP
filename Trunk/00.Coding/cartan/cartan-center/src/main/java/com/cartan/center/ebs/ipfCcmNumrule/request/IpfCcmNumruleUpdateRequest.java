...
public class IpfCcmNumruleUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmNumruleUpdateRequest(){}
	
	public IpfCcmNumruleUpdateRequest(IpfCcmNumrule ipfCcmNumrule){
	...
	public static List<IpfCcmNumrule> cloneBOList(List<IpfCcmNumruleUpdateRequest> vos){
		...
		for(IpfCcmNumruleUpdateRequest vo: vos){
