...
public class IpfCcmEnvironmentUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmEnvironmentUpdateRequest(){}
	
	public IpfCcmEnvironmentUpdateRequest(IpfCcmEnvironment ipfCcmEnvironment){
	...
	public static List<IpfCcmEnvironment> cloneBOList(List<IpfCcmEnvironmentUpdateRequest> vos){
		...
		for(IpfCcmEnvironmentUpdateRequest vo: vos){
