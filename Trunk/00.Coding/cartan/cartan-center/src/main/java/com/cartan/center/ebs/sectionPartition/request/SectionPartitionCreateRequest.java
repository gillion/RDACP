...
public class SectionPartitionCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public SectionPartitionCreateRequest(){}
	
	public SectionPartitionCreateRequest(SectionPartition sectionPartition){
	...
	public static List<SectionPartition> cloneBOList(List<SectionPartitionCreateRequest> vos){
		...
		for(SectionPartitionCreateRequest vo: vos){
