...
public class RuleTableInputSelectRequest extends AbstractRopRequest {
	...
	public RuleTableInputSelectRequest(){}
	
	public RuleTableInputSelectRequest(RuleTableInput ruleTableInput){
	...
	public static List<RuleTableInput> cloneBOList(List<RuleTableInputSelectRequest> vos){
		...
		for(RuleTableInputSelectRequest vo: vos){
