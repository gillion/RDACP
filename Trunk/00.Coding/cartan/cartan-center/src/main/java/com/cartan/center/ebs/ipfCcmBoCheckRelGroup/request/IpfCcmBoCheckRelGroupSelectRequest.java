...
public class IpfCcmBoCheckRelGroupSelectRequest extends AbstractRopRequest {
	...
	public IpfCcmBoCheckRelGroupSelectRequest(){}
	
	public IpfCcmBoCheckRelGroupSelectRequest(IpfCcmBoCheckRelGroup ipfCcmBoCheckRelGroup){
	...
	public static List<IpfCcmBoCheckRelGroup> cloneBOList(List<IpfCcmBoCheckRelGroupSelectRequest> vos){
		...
		for(IpfCcmBoCheckRelGroupSelectRequest vo: vos){
