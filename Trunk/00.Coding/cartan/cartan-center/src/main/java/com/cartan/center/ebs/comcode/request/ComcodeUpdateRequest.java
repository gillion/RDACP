...
public class ComcodeUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 100)
	...
	public ComcodeUpdateRequest(){}
	
	public ComcodeUpdateRequest(Comcode comcode){
