...
public class MemberVoteSelectRequest extends AbstractRopRequest {
	...
	public MemberVoteSelectRequest(){}
	
	public MemberVoteSelectRequest(MemberVote memberVote){
