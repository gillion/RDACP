...
public class CodegenerRadioUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public CodegenerRadioUpdateRequest(){}
	
	public CodegenerRadioUpdateRequest(CodegenerRadio codegenerRadio){
	...
	public static List<CodegenerRadio> cloneBOList(List<CodegenerRadioUpdateRequest> vos){
		...
		for(CodegenerRadioUpdateRequest vo: vos){
