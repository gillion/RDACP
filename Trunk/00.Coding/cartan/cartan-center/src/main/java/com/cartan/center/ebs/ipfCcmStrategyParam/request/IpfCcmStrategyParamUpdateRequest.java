...
public class IpfCcmStrategyParamUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmStrategyParamUpdateRequest(){}
	
	public IpfCcmStrategyParamUpdateRequest(IpfCcmStrategyParam ipfCcmStrategyParam){
	...
	public static List<IpfCcmStrategyParam> cloneBOList(List<IpfCcmStrategyParamUpdateRequest> vos){
		...
		for(IpfCcmStrategyParamUpdateRequest vo: vos){
