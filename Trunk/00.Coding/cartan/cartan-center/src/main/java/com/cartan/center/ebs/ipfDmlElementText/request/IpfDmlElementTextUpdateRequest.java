...
public class IpfDmlElementTextUpdateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfDmlElementTextUpdateRequest(){}
	
	public IpfDmlElementTextUpdateRequest(IpfDmlElementText ipfDmlElementText){
	...
	public static List<IpfDmlElementText> cloneBOList(List<IpfDmlElementTextUpdateRequest> vos){
		...
		for(IpfDmlElementTextUpdateRequest vo: vos){
