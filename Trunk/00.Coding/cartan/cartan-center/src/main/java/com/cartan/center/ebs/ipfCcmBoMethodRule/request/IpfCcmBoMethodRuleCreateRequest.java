...
public class IpfCcmBoMethodRuleCreateRequest extends AbstractRopRequest {
	@Size(min = 0, max = 50)
	...
	public IpfCcmBoMethodRuleCreateRequest(){}
	
	public IpfCcmBoMethodRuleCreateRequest(IpfCcmBoMethodRule ipfCcmBoMethodRule){
	...
	public static List<IpfCcmBoMethodRule> cloneBOList(List<IpfCcmBoMethodRuleCreateRequest> vos){
		...
		for(IpfCcmBoMethodRuleCreateRequest vo: vos){
