package com.cartan.core.ruleTable.domain;
...
public class RuleTable implements Serializable{
	...
	private String RULE_TABLE_NAME;//决策表名称
	...
	public String getRuleTableName() {
		return this.RULE_TABLE_NAME;
	}
	
	public void setRuleTableName(String value) {
		this.RULE_TABLE_NAME = value;
	}
