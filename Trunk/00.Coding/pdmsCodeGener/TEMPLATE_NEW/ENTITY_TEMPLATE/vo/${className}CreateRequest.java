...
public class ${className}CreateRequest extends AbstractRopRequest {
	...
	public ${className}CreateRequest(){}
	
	public ${className}CreateRequest(${className} ${classNameLower}){
