...
<div>
    <ul id="testDetail">
		<li><label>ID主键:</label><input name="id" type="text" style="border: solid 1px #ccc"></li>
        <@generateMajorFileld/>
    </ul>
</div>
<script>
...
<#if !column.sqlName?starts_with("DEFINE") && !column.pk && isComm == 0 && column.javaType=="String">
		<li><label>${column.columnAlias}:</label><input name="${column.columnName?uncap_first}" type="text" style="border: solid 1px #ccc"></li>
</#if> 
</#list> 
</#macro>
