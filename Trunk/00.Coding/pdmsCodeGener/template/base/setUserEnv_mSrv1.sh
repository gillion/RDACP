...
USER_MEM_ARGS="-XX:MaxPermSize=512M -Xms1024M -Xmx2048M -XX:+HeapDumpOnOutOfMemoryError -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:/home/ap/crmc_spm/domains/crmc_spm/servers/mSrv1/logs/gc_mSrv1.log"
